    ...
    >
      ...
      >
        ...
        <img
          src={cloud1}
          alt="Cloud 1"
          className="absolute w-[20%] sm:w-[10%] xl:w-[10%] z-0 transition-transform duration-[600ms] ease-out will-change-transform"
          style={{
            top: '0%',
            left: '10%',
        ...
        <img
          src={cloud2}
          alt="Cloud 2"
          className="absolute w-[18%] sm:w-[9%] xl:w-[9%] z-0 transition-transform duration-[600ms] ease-out will-change-transform"
          style={{
            top: '4%',
            right: '-8%',
        ...
        <img
          src={airplane2}
          alt="Airplane"
          className="absolute w-[28%] sm:w-[20%] xl:w-[20%] z-0 transition-transform duration-[600ms] ease-out will-change-transform"
          style={{
            bottom: '0%',
            right: '5%',
      ...
      <div className="min-w-full h-screen snap-start flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-blue-300 text-gray-800 px-[2%]">
        <h2 className="text-xl sm:text-2xl xl:text-3xl font-bold mb-4 sm:mb-6 xl:mb-8">Uber</h2>
        <p className="text-sm sm:text-base xl:text-lg leading-relaxed mb-4 sm:mb-6 xl:mb-8">Strategy & Planning Lead (3 years)</p>
